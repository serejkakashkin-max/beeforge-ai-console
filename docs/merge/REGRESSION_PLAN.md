...
| New shell | Starts beside legacy; no write on view/open | Self-contained win-x64 preview published and startup-smoked; selected profile shows legacy argv; visual/accessibility QA pending |
