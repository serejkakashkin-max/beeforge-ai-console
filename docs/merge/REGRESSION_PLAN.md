...
| Final cutover | Every old feature PASS or explicit BLOCKED in `FINAL_PARITY_REPORT.md` | Implementation parity report complete; default-launcher switch remains BLOCKED only by the live/manual gates documented there |
